        ...
        if (NULL !== $this->_renderer->getApplication()->getBBUserToken()) {
            ...
            if (NULL !== $object) {
                ...
                if (is_a($object, '\BackBuilder\ClassContent\ContentSet')) {
                    ...
                    /* add defaut contentnode plugins. Later, move to plugins.yml except rootContentSet*/
                            ...
                            if (array_key_exists("useItemcontainer", $params)) {
                                if (isset($contentMarkup)) {
                                    ...
                                    if (is_array($contentMarkup) && array_key_exists("droppableclass", $contentMarkup)) {
                                        ...
                                        if (!array_key_exists('class', $cloneDatacontent)) {
                                            $cloneDatacontent['class'] = '';
                                        }
                ...
                if ( NULL !== $this->_renderer->getClassContainer() && is_a($this->_renderer->getClassContainer(), '\BackBuilder\ClassContent\ContentSet')
                        && !($this->_renderer->getClassContainer() instanceof \BackBuilder\ClassContent\Bloc\autobloc)) {
                    if (!array_key_exists('class', $datacontent))
                        $datacontent['class'] = '';
