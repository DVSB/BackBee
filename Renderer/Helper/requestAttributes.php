...
/**
 * Helper returning current request attributes.
 *
 * @category    BackBee
 *
 ...
 */
class requestAttributes extends AbstractHelper
{
    /**
    ...
    public function __invoke()
    {
        if (null !== $this->_renderer
            ...
            return $this->_renderer->getApplication()->getController()->getRequest()->attributes;
        }
