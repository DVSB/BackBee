            ...
            load_node_json: function (obj, s_call, e_call) {
                ...
                switch (!0) {
                    ...
                    case (!s.data && !!s.ajax) || (!!s.data && !!s.ajax && obj && obj !== -1):
                        ...
                        if (!s.ajax.webservice) throw "No RPC webservice supplied.";
                        if (!s.ajax.webservice.instance) throw "No RPC webservice instance supplied.";
                        if (!s.ajax.webservice.method) throw "No RPC webservice method supplied.";
