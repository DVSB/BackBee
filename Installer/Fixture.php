...
use BackBuilder\BBApplication,
    BackBuilder\Installer\Annotation\Fixture as AnnotationFixture,
    BackBuilder\Installer\Annotation\Fixtures as AnnotationFixtures;
...
class Fixture
{
    ...
    {
        if (!$this->isFixturedEntity($classMetadata->getReflectionClass())) return;
        $class = $this->getClass($classMetadata);
