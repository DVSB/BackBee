...
use BackBuilder\Security\Role\RoleHierarchy,
    BackBuilder\Security\Acl\Domain\SecurityIdentityRetrievalStrategy,
    BackBuilder\Security\Authentication\TrustResolver,
    BackBuilder\Security\Acl\Permission\PermissionMap,
    BackBuilder\Security\Acl\Permission\MaskBuilder,
    BackBuilder\Security\Token\UsernamePasswordToken,
    BackBuilder\Security\Authorization\Voter\BBAclVoter,
